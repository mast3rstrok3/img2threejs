...
function makeMaterials() {
  ...
  const doppler = new THREE.MeshPhysicalMaterial({
    map: projectedTex('/m9-doppler/blade-fill.png'), metalness: 0.0, roughness: 0.34,
    clearcoat: 0.85, clearcoatRoughness: 0.07, envMapIntensity: 0.9,
  });
  const handleTex = new THREE.MeshPhysicalMaterial({
    map: projectedTex('/m9-doppler/handle-fill.png'), metalness: 0.1, roughness: 0.62, envMapIntensity: 0.7,
  });
