...
function loadMaps(): Maps {
  return {
    front: tex(frontAlbedoUrl.src, true),
    back: tex(backAlbedoUrl.src, true),
    rough: tex(roughnessUrl.src, false),
    metal: tex(metalnessUrl.src, false),
    ao: tex(aoUrl.src, false),
    normal: tex(normalUrl.src, false),
  };
}
