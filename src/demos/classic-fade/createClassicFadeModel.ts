...
function loadMaps(): Maps {
  return {
    front: projected(frontAlbedoUrl.src, true),
    back: projected(backAlbedoUrl.src, true),
    rough: projected(roughnessUrl.src, false),
    metal: projected(metalnessUrl.src, false),
    ao: projected(aoUrl.src, false),
    normal: projected(normalUrl.src, false),
